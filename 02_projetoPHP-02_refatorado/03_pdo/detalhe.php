...
$titulo_pagina = htmlspecialchars($tec['nome']);
$pagina_ataual = "catalogo";
?>
...
<body>
    ...
    <a href="index.php" style="color: #3b579d; font-weight: bold;">Voltar ao catalogo</a>
...
<table style="width: 100%; border-collapse: collapse; margin-top: 20px; font-size: 14px;">
    ...
    <tr style="padding: 10px; border: 1px solid #e5e7eb; font-weight: bold;">
